public class 주사위게임1 {
    ...
    public int solution(int a, int b) {
        int answer = 0;
        if(a % 2 == 1 && b % 2 == 1){ // 나머지 연산자와 숫자를 올바르게 사용합니다.
            answer = a * a + b * b; // 제곱 연산자는 *로 표현합니다.
        } else if(a % 2 == 1 && b % 2 == 0){
            answer = 2 * (a + b); // 곱셈 연산자는 *로 표현합니다.
        } else if(a % 2 == 0 && b % 2 == 1){
            answer = 2 * (a + b); // 곱셈 연산자는 *로 표현합니다.
        } else if (a % 2 == 0 && b % 2 == 0){
            answer = Math.abs(a - b); // 절댓값 연산자는 Math.abs() 함수를 사용합니다.
        }
        return answer;
    }
}
...
a와 b 모두 홀수가 아니라면 = 둘다 짝수 |a - b| 점을 얻습니다.
